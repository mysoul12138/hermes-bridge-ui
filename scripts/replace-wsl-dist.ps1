...
param(
    ...
    [string]$SourceDist = "/mnt/e/BaiduNetdiskDownload/auto/hermes-bridge-ui/dist",
...
$bashLines = @(
    ...
    "echo ""client bundles:""",
    "ls -1 ""`$pkg/dist/client/assets/js"" | grep -E '^(index-|ChatView-)' | sort || true",
    "echo ""server markers:""",
    'echo "server file: $pkg/dist/server/index.js"'
)
