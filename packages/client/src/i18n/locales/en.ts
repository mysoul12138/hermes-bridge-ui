export default {
  ...
  sidebar: {
    ...
    reloadClientVersion: 'Update to v{version}',
    updating: 'Updating...',
  ...
  chat: {
    ...
    approvalDeny: 'Deny',
    approvalPendingCount: 'Approval {current} of {total}',
    approvalDangerousCommand: 'This action requires your approval.',
    approvalResponding: 'Submitting approval response...',
    branchActiveHint: 'Viewing branch session',
    branchSession: 'Branch session',
    branchSessions: '{count} branch sessions',
    branchTreeShowAll: 'Show {count} more branches',
    branchTreeShowLatest: 'Show latest branches',
    busyInputQueued: '{count} message(s) queued',
    busyInputWillQueue: 'This session is running; the message will be queued.',
    clarifyCustomPlaceholder: 'Type a custom response...',
    clarifyResponding: 'Submitting response...',
    clarifySend: 'Send response',
    clarifyTitle: 'Clarification needed',
    messageQueued: 'Queued',
    messageSteered: '/steer injected',
    steerMessage: 'Steer message',
    busyInputWillSteer: 'This session is running; sending injects /steer into the current turn.',
  ...
  models: {
    ...
    aliasPlaceholder: 'Leave blank to use the canonical model ID',
    aliasHint: 'Only changes the Web UI display name. Hermes calls still use the canonical model ID.',
    aliasCanonical: 'Canonical ID: {model}',
    aliasUseOriginal: 'Use canonical ID',
  ...
  settings: {
    ...
    display: {
      ...
      assistantNameHint: 'Customize the assistant name shown in chat messages',
      assistantNamePlaceholder: 'Hermes',
      assistantAvatar: 'Assistant Avatar',
      assistantAvatarHint: 'Customize the avatar shown for assistant messages',
      avatarHeicUnsupported: 'HEIC images are not supported yet',
      ...
      busyInputModeQueue: 'Queue',
      busyInputModeSteer: 'Steer',      theme: 'Theme',
    ...
    voice: {
      ...
      edgeRate: 'Rate',
      edgeRateHint: 'Adjust speech speed (0.5x to 2.0x)',
      edgePitch: 'Pitch',
      edgePitchHint: 'Adjust speech pitch (-20 to +20 Hz)',
