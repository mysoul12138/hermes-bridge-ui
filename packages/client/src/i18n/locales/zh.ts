export default {
  ...
  chat: {
    ...
    approvalDeny: '拒绝',
    approvalPendingCount: '第 {current} / {total} 个审批',
    approvalDangerousCommand: '此操作需要你的批准。',
    approvalResponding: '正在提交审批响应...',
    branchActiveHint: '正在查看分支会话',
    branchSession: '分支会话',
    branchSessions: '{count} 个分支会话',
    branchTreeShowAll: '显示其余 {count} 个分支',
    branchTreeShowLatest: '只显示最新分支',
    busyInputQueued: '已排队 {count} 条消息',
    busyInputWillQueue: '当前会话正在运行，消息将进入队列。',
    clarifyCustomPlaceholder: '输入自定义回复...',
    clarifyResponding: '正在提交回复...',
    clarifySend: '发送回复',
    clarifyTitle: '需要澄清',
    messageQueued: '已排队',
    messageSteered: '/steer 已注入',
    steerMessage: '注入指令',
    busyInputWillSteer: '当前会话正在运行，发送将作为 /steer 注入到当前轮次。',
    queueMessage: '排队发送',
  ...
  settings: {
    ...
    display: {
      ...
      assistantName: '助手名称',
      assistantNameHint: '自定义会话消息中显示的助手名称',
      assistantNamePlaceholder: 'Hermes',
      assistantAvatar: '助手头像',
      assistantAvatarHint: '自定义助手消息中显示的头像',
      avatarHeicUnsupported: '暂不支持 HEIC 图片',
      avatarInvalid: '请选择有效的图片文件',
      avatarTooLarge: '图片过大',
      resetAvatar: '重置头像',
      uploadAvatar: '上传头像',
      avatarCropTitle: '裁切头像',
      avatarCropZoom: '缩放',
      avatarCropApply: '应用头像',
      showCost: '显示费用',
      ...
      busyInputModeQueue: '排队',
      busyInputModeSteer: 'Steer 注入',      theme: '主题',
  ...
  changelog: {
    ...
    new_0_5_14_4: '修复服务关闭时 SQLite 连接未释放导致重启后数据库被锁的问题',
      new_0_5_14_5: '迁移到 Responses API，实现更快的流式传输和改进的消息合并',
    ...
    new_0_5_16_1: '将聊天流式传输从 /v1/runs 迁移到 /v1/responses API 以降低延迟',
    new_0_5_16_2: '持久化真实 API 用量（tokens、缓存、推理）到用量表',
    new_0_5_16_3: '网站导航栏新增 QQ 群二维码',
    new_0_5_16_4: '移除消息模式中未使用的 codex_reasoning_items 字段',
