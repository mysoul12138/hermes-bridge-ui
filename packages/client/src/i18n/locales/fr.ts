export default {
  ...
  chat: {
    ...
    branchActiveHint: 'Affichage de la session branche',
    branchSession: 'Session branche',
    branchSessions: '{count} sessions branches',
    branchTreeShowAll: 'Afficher {count} branches supplémentaires',
    branchTreeShowLatest: 'Afficher les dernières branches',
    busyInputQueued: '{count} message(s) en file d\'attente',
    busyInputWillQueue: 'Cette session est en cours ; le message sera mis en file d\'attente.',
    clarifyCustomPlaceholder: 'Tapez une réponse personnalisée...',
...
new_0_5_14_4: 'Fix SQLite connection not released on shutdown causing database lock on restart',
      new_0_5_14_5: 'Migration vers l\'API Responses pour un streaming plus rapide et une meilleure fusion des messages',
