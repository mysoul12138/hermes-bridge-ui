export default {
  ...
  chat: {
    ...
    messageSteered: '/steer injetado',
    busyInputWillSteer: 'Esta sessão está em execução; enviar injeta /steer no turno atual.',
    ...
    approvalDeny: 'Negar',
    approvalPendingCount: 'Aprovação {current} de {total}',
    approvalDangerousCommand: 'Esta ação requer sua aprovação.',
    approvalResponding: 'Enviando resposta de aprovação...',
...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: 'Permitir injeção /steer enquanto a IA processa',

      busyInputModeQueue: 'Fila',
      busyInputModeSteer: 'Injetar',      theme: 'Tema',
...
new_0_5_14_4: 'Fix SQLite connection not released on shutdown causing database lock on restart',
      new_0_5_14_5: 'Migração para a API Responses para streaming mais rápido e melhor fusão de mensagens',
