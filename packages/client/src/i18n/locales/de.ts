export default {
  ...
  chat: {
    ...
    busyInputWillSteer: 'Diese Sitzung läuft; Senden fügt /steer in die aktuelle Runde ein.',
    ...
    approvalPendingCount: 'Genehmigung {current} von {total}',
    approvalDangerousCommand: 'Diese Aktion erfordert deine Genehmigung.',
    approvalResponding: 'Genehmigungsantwort wird gesendet...',
...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: '/steer während der KI-Verarbeitung erlauben',

      busyInputModeQueue: 'Warteschlange',
      busyInputModeSteer: 'Injizieren',      theme: 'Design',
...
new_0_5_14_4: 'Fix SQLite connection not released on shutdown causing database lock on restart',
      new_0_5_14_5: 'Migration zur Responses API für schnelleres Streaming und verbesserte Nachrichtenzusammenführung',
