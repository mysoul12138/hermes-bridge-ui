export default {
  ...
  chat: {
    ...
    busyInputWillSteer: 'Esta sesión está en ejecución; enviar inyecta /steer en el turno actual.',
    ...
    approvalTitle: 'Aprobación requerida',
    ...
    approvalPendingCount: 'Aprobación {current} de {total}',
    approvalDangerousCommand: 'Esta acción requiere tu aprobación.',
    approvalResponding: 'Enviando respuesta de aprobación...',
...
jobTriggered: 'Job ejecutado',
  ...
  memory: {
    title: 'Memoria',
    refresh: 'Actualizar',
    refreshSuccess: 'Memoria actualizada',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: 'Permitir inyección /steer mientras la IA procesa',

      busyInputModeQueue: 'Cola',
      busyInputModeSteer: 'Inyectar',      theme: 'Tema',
...
new_0_5_14_4: 'Fix SQLite connection not released on shutdown causing database lock on restart',
      new_0_5_14_5: 'Migración a la API Responses para streaming más rápido y mejor fusión de mensajes',
